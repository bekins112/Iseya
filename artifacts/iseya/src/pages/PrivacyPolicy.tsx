...
import { ArrowLeft, Shield, Eye, Users, Lock, UserCheck, Clock, Baby, Globe, RefreshCw, Mail , Linkedin } from "lucide-react" ;
...
import { privacyDefaults } from "@/lib/page-content/privacy";

export default function PrivacyPolicy() {
  usePageTitle("Privacy Policy");
  const c = usePageContent("page_privacy", privacyDefaults);
  const container = {
    hidden: { opacity: 0 },
    show: {
      opacity: 1,
      ...
      <div className="pt-24 pb-16 px-4 md:px-8 max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-display font-bold mb-4" data-testid="text-privacy-policy-title">{c.header.title}</h1>
