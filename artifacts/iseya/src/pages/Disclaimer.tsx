...
import { ArrowLeft, AlertTriangle, Shield, Scale, FileText, Info , Linkedin } from "lucide-react" ;
...
import { disclaimerDefaults } from "@/lib/page-content/disclaimer";

export default function Disclaimer() {
  usePageTitle("Disclaimer");
  const c = usePageContent("page_disclaimer", disclaimerDefaults);
  const container = {
    hidden: { opacity: 0 },
    show: {
      opacity: 1,
  ...
  const sections = c.sections.items;
      ...
      <div className="pt-24 pb-16 px-4 md:px-8 max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-display font-bold mb-4" data-testid="text-disclaimer-title">{c.header.title}</h1>
