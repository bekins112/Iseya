...
export const adminUpdateUserSchema = z.object({
  ...
  jobAidPlan: z.enum(["casual", "smart", "remote", "freelance", "corporate"]).optional().nullable(),
  jobAidStatus: z.enum(["none", "active", "expired"]).optional(),
  jobAidEndDate: z.string().optional().nullable(),
